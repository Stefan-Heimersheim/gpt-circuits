...
#Edit these!
model_names = [f'davidquarel/jblock.shk_64x4-sparse-{sparsity}' for sparsity in sparsities] #This has to point to existing models
local_dirs = [f'checkpoints/jblock.shk_64x4-sparse-{sparsity}' for sparsity in sparsities] #This could be anywhere you want the model saved to
save_names = ['jblock.shk_64x4-sparse-{sparsity}.safetensors' for sparsity in sparsities] #This could be any name, but it should be unique for each run you want
